...
// line 52 "../../../../../RestoAppPersistence2.ump"
// line 134 "../../../../../RestoApp-v7.ump"
public class Order implements Serializable
{
  ...
  public boolean setTakeOut(TakeOut aNewTakeOut)
  {
    boolean wasSet = false;
    if (takeOut != null && !takeOut.equals(aNewTakeOut) && equals(takeOut.getOrder()))
    {
      //Unable to setTakeOut, as existing takeOut would become an orphan
      return wasSet;
    }

    takeOut = aNewTakeOut;
    Order anOldOrder = aNewTakeOut != null ? aNewTakeOut.getOrder() : null;

    if (!this.equals(anOldOrder))
    {
      if (anOldOrder != null)
      {
        anOldOrder.takeOut = null;
      }
      if (takeOut != null)
      {
        takeOut.setOrder(this);
      }
    }
    wasSet = true;
    return wasSet;
  ...
  public void delete()
  {
    ...
    TakeOut existingTakeOut = takeOut;
    takeOut = null;
    if (existingTakeOut != null)
    {
      existingTakeOut.delete();
    }
  ...
  // line 58 "../../../../../RestoAppPersistence2.ump"
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "  " + "takeOut = "+(getTakeOut()!=null?Integer.toHexString(System.identityHashCode(getTakeOut())):"null");
  }  
  //------------------------
  // DEVELOPER CODE - PROVIDED AS-IS
  //------------------------
  
  // line 55 "../../../../../RestoAppPersistence2.ump"
