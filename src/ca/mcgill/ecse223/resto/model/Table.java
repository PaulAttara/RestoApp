...
// line 33 "../../../../../RestoAppPersistence2.ump"
// line 1 "../../../../../RestoAppTableStateMachine2.ump"
// line 67 "../../../../../RestoApp-v7.ump"
public class Table implements Serializable
{
  ...
  {
	  System.out.println(tablesByNumber);
    x = aX;
    y = aY;
    width = aWidth;
    length = aLength;
  ...
  public boolean startOrder()
  {
    ...
    {
      case Available:
        // line 4 "../../../../../RestoAppTableStateMachine2.ump"
  ...
  public boolean addToOrder(Order o)
  {
    ...
    {
      case Available:
        // line 7 "../../../../../RestoAppTableStateMachine2.ump"
        o.addTable(this);
        setStatus(Status.NothingOrdered);
        wasEventProcessed = true;
        break;
  ...
  public boolean orderItem(int quantity,Order o,Seat s,PricedMenuItem i)
  {
    ...
    switch (aStatus)
    {
      case NothingOrdered:
        ...
        {
        // line 12 "../../../../../RestoAppTableStateMachine2.ump"
      ...
      case Ordered:
        if (quantityIsPositive(quantity))
        {
        // line 27 "../../../../../RestoAppTableStateMachine2.ump"
          // create a new order item with the provided quantity, order, seat, and priced menu item
        	  o.addOrderItem(quantity, i, s);
        	setStatus(Status.Ordered);
          wasEventProcessed = true;
  ...
  public boolean addToOrderItem(OrderItem i,Seat s)
  {
    ...
    {
      case NothingOrdered:
        // line 15 "../../../../../RestoAppTableStateMachine2.ump"
        ...
        break;
      case Ordered:
        // line 30 "../../../../../RestoAppTableStateMachine2.ump"
        // add provided seat to provided order item unless seat has already been added, in which case nothing needs to be done
    	  i.addSeat(s);
    	  setStatus(Status.Ordered);
        wasEventProcessed = true;
  ...
  public boolean endOrder(Order o)
  {
    ...
    {
      case NothingOrdered:
        // line 18 "../../../../../RestoAppTableStateMachine2.ump"
      ...
      case Ordered:
        if (allSeatsBilled())
        {
        // line 52 "../../../../../RestoAppTableStateMachine2.ump"
  ...
  public boolean cancelOrderItem(OrderItem i)
  {
    ...
    switch (aStatus)
    {
      case Ordered:
        if (iIsLastItem(i))
        {
        // line 33 "../../../../../RestoAppTableStateMachine2.ump"
          // delete order item
        ...
        if (!(iIsLastItem(i)))
        {
        // line 36 "../../../../../RestoAppTableStateMachine2.ump"
          for(Seat seat : i.getSeats())
        	seat.removeOrderItem(i);
          i.delete();
          setStatus(Status.Ordered);
  ...
  public boolean cancelOrder()
  {
    ...
    {
      case Ordered:
        // line 39 "../../../../../RestoAppTableStateMachine2.ump"
    	 for(Order o : this.getOrders()) {
    		 
    		 for(OrderItem oi : o.getOrderItems()) {
    			 for(Seat seat : oi.getSeats())
    		        	seat.removeOrderItem(oi);
    			 oi.delete();
    		 }
    	 }
        setStatus(Status.NothingOrdered);
  ...
  public boolean billForSeat(Order o,Seat s)
  {
    ...
    {
      case Ordered:
        // line 42 "../../../../../RestoAppTableStateMachine2.ump"
    	  if(s.hasBills()) {
    		 Bill b = s.getBill(0);
    			  System.out.println("hello");
    			  System.out.println(b.removeIssuedForSeat(s));
    			  if(!b.hasIssuedForSeats()) b.delete();
    			  System.out.println("bye");
    		  
    		 }
    	  System.out.println("producing");
    	  new Bill(o, getRestoApp(), s);
  ...
  public boolean addToBill(Bill b,Seat s)
  {
    ...
    {
      case Ordered:
        // line 47 "../../../../../RestoAppTableStateMachine2.ump"
    	  ...
    	  if(b.getIssuedForSeats().contains(s)) {
    		  ...
    		  if(s.hasBills()) {
    			  if(s.getBill(0).getOrder() == b.getOrder() && !s.getBills().get(0).equals(b))
  ...
  // line 39 "../../../../../RestoAppPersistence2.ump"
   ...
   */
  // line 59 "../../../../../RestoAppTableStateMachine2.ump"
   ...
   */
  // line 74 "../../../../../RestoAppTableStateMachine2.ump"
   public boolean iIsLastItem(OrderItem i){
    Order currentOrder = i.getOrder();
		  
    if (currentOrder.numberOfOrderItems() == 1){
      	return true;
      }
      return false;
  }
   ...
   */
  // line 91 "../../../../../RestoAppTableStateMachine2.ump"
  ...
  // line 36 "../../../../../RestoAppPersistence2.ump"
